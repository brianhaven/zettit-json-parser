...
class MarketAwareReportTypeExtractor:
    ...
    def _get_available_market_types(self) -> set:
        """
        Get available market term types from database dynamically.
        ...
        try:
            ...
            # Get market term patterns from database
            temp_manager = PatternLibraryManager()
            market_patterns = temp_manager.get_patterns(PatternType.MARKET_TERM)
    ...
    def extract(self, title: str, market_term_type: str = "standard", 
        ...
        if market_term_type in available_market_types:
            ...
            # For standard titles: use database pattern matching
            best_result = self._try_standard_pattern_extraction(title)
